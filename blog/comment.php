...
if ($stmt->rowCount() != 0) {
    echo "
<br>
<form class=\"form-horizontal\" action=\"step-2.php\" method=\"post\" style=\"background-color: white;text-align: center;\">
    <fieldset>
        ...
        <div class=\"form-group\">
            <label class=\"col-md-4 control-label\" for=\"textinput\">Your comment</label>
            <div class=\"col-md-4\">
                <input name=\"reply\" type=\"text\" placeholder=\"Your reply\" class=\"form-control input-md\" required=\"\">
                <input type=\"hidden\" name=\"blogid\" value=\"".$result->id." \"><br>
